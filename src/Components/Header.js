...
export default function Header() {
  ...
  return (
    <header>
      <nav>
        <div className="Logo">
          <img src={logo} alt="logo" id="home" onClick={handleClick} />
          <h2>Tasty Kitchens</h2>
        </div>
        <ul className="Nav-contents">
          <li onClick={handleClick} id="home">Home</li>
          <li id="cart" onClick={handleClick}>Cart</li>
          <li><button type="button" className="logout" onClick={logOut}>Logout</button></li>
        </ul>
      ...
      <div className="img-container">
        <Slider {...settings}>
          {data?.map((item) => (
            <img src={item.image_url} alt="slider img" key={item.id} />
          ))}
        </Slider>
      </div>
    </header>
...
export function NavBar() {
  ...
  return (
    <header>
      <nav>
        <div className="Logo">
          <img src={logo} id="home" alt="logo" onClick={handleClick} />
          <h2>Tasty Kitchens</h2>
        </div>
        <ul className="Nav-contents">
          <li onClick={handleClick} id="home">Home</li>
